...
import ongc from "../../assets/logo/ongc_logo.png"
  ...
  return (
    <>
      <Container>
        <Svg1 src={ToDoList} />
        <Svg2 src={ToDoList} />
        <h1 className="heading"> Past Recruiters</h1>
        ...
        <div className="company_container">
          <Card onClick={(event) => (navigate("/placement/Google%20India/2022"))}>
            <h3>GOOGLE</h3>
            <img style={logo_style} alt="google logo" src={google}></img>
          </Card>
          <Card onClick={(event) => (navigate("/placement/Microsoft/2022"))}>
            <h3>MICROSOFT</h3>
            <img style={logo_style} alt="google logo" src={microsoft}></img>
          </Card>
          <Card onClick={(event) => (navigate("/placement/Amazon/2022"))}>
            <h3>AMAZON</h3>
            <img style={logo_style} alt="google logo" src={amazon}></img>
          </Card>
          <Card onClick={(event) => (navigate("/placement/ONGC%20/2022"))}>
            <h3>ONGC</h3>
            <img style={logo_style} alt="google logo" src={ongc}></img>
          </Card>
          <Card onClick={(event) => (navigate("/placement/SPRINKLR(PE%20&%20DS)/2021"))}>
            <h3>SPRINKLR</h3>
            <img
              style={{ height: "40%" }}
              alt="google logo"
        ...
        <Button
          onClick={(event) => (navigate("/insight/placement/2022"))}
        >
          View All
        </Button>
      </Container>
