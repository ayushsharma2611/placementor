...
export default function InsightPlacementmme() {
...
const BranchLink = styled(Link)`
  ...
  return (
    <>
      ...
      <Div>
      <div class="dropdown">
            <button class="dropbtn">MME</button>
            <div class="dropdown-content">
              ...
              <div class="sub-heading">B.Tech</div>
                ...
                <BranchDiv>
                  ...
                  <BranchLink activeColor="rgba(238, 109, 152, 1)" to="/insight/placement/2021/mme">
                    MME
                  </BranchLink>
      ...
      <CompanyFetch url="placement" query={query} type="placement" year="2021" branch = "mme"/>
    </>
  );
}
