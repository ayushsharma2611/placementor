...
export default function InsightPlacement2022mech() {
...
const BranchLink = styled(Link)`
  ...
  return (
    <>
            ...
            <div class="dropdown-content">
              ...
              <div class="sub-heading">B.Tech</div>
                ...
                <BranchDiv>
                  ...
                  <BranchLink activeColor="rgba(238, 109, 152, 1)" to="/insight/placement/2022/mech">
                    Mech
                  </BranchLink>
      ...
      <CompanyFetch url="placement" query={query} type="placement" year="2022" branch="mech"/>
    </>
  );
}
