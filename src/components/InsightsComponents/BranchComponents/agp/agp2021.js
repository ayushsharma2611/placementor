...
export default function InsightPlacementagp() {
...
const BranchLink = styled(Link)`
  ...
  return (
    <>
      ...
      <Div>
      <div class="dropdown">
            <button class="dropbtn">AGP</button>
            <div class="dropdown-content">
              ...
              <BranchDiv>
                  ...
                  <BranchLink activeColor="rgba(238, 109, 152, 1)" to="/insight/placement/2021/agp">
                    AGP
                  </BranchLink>
      ...
      <CompanyFetch url="placement" query={query} type="placement" year="2021" branch = "agp"/>
    </>
  );
}
