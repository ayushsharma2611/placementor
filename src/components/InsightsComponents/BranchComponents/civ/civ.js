...
export default function InsightPlacement2022ce() {
...
const BranchLink = styled(Link)`
  ...
  return (
    <>
      ...
      <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              <div class="sub-heading">B.Tech</div>
                <BranchDiv>
                  <BranchLink activeColor="rgba(238, 109, 152, 1)" to="/insight/placement/2022/ce">
                    CE
                  </BranchLink>
      ...
      <CompanyFetch url="placement" query={query} type="placement" year="2022" branch="ce"/>
    </>
  );
}
