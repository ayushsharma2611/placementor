...
export default function InsightPlacementcse() {
...
const BranchLink = styled(Link)`
  ...
  return (
    <>
            ...
            <div class="dropdown-content">
              ...
              <div class="sub-heading">B.Tech</div>
                <BranchDiv>
                  ...
                  <BranchLink activeColor="rgba(238, 109, 152, 1)" to="/insight/placement/2021/cse">
                    CSE
                  </BranchLink>
      ...
      <CompanyFetch url="placement" query={query} type="placement" year="2021" branch = "cse"/>
    </>
  );
}
