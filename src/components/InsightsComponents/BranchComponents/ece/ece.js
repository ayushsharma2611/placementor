...
export default function InsightPlacement2022ece() {
    ...
    <>
      ...
      <div class="dropdown">
            ...
            <div class="dropdown-content">
                <BranchDiv>
                  <BranchLink activeColor="rgba(238, 109, 152, 1)" to="/insight/placement/2022">
                    All
                  </BranchLink>
                </BranchDiv>
              <div class="sub-heading">B.Tech</div>
                <BranchDiv>
                  ...
                  <BranchLink activeColor="rgba(238, 109, 152, 1)" to="/insight/placement/2022/ece">
                    ECE
                  </BranchLink>
                </BranchDiv>
                <BranchDiv>
                  ...
                  <BranchLink to="/insight/placement/2022/ep">
                    EP
                  </BranchLink>
      ...
      <CompanyFetch url="placement" query={query} type="placement" year="2022" branch="ece"/>
    </>
  );
}
