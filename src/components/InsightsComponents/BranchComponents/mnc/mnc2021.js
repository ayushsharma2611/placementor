...
export default function InsightPlacementmnc() {
...
const BranchLink = styled(Link)`
  ...
  return (
    <>
      ...
      <Div>
      <div class="dropdown">
            <button class="dropbtn">M&C</button>
            <div class="dropdown-content">
              ...
              <div class="sub-heading">B.Tech</div>
                ...
                <BranchDiv>
                  ...
                  <BranchLink to="/insight/placement/2021/mech">
                    Mech
                  </BranchLink>
              ...
              <BranchDiv>
                  ...
                  <BranchLink activeColor="rgba(238, 109, 152, 1)" to="/insight/placement/2021/mnc">
                    M&C
                  </BranchLink>
                </BranchDiv>
            </div>
      ...
      <CompanyFetch url="placement" query={query} type="placement" year="2021" branch = "m&c"/>
    </>
  );
}
