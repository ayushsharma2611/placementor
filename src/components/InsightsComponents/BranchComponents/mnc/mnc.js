...
export default function InsightPlacement2022mnc() {
...
const BranchLink = styled(Link)`
  ...
  return (
    <>
      ...
      <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              <BranchDiv>
                  ...
                  <BranchLink activeColor="rgba(238, 109, 152, 1)" to="/insight/placement/2022/mnc">
                    M&C
                  </BranchLink>
                </BranchDiv>
            </div>
      ...
      <CompanyFetch url="placement" query={query} type="placement" year="2022" branch="mnc"/>
    </>
  );
}
