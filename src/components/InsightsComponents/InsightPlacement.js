  ...
  return (
    <>
      ...
      <Div>
          ...
          <div class="dropdown">
            <button class="dropbtn">All Branches</button>
            <div class="dropdown-content">
                <BranchDiv>
                  <BranchLink activeColor="rgba(238, 109, 152, 1)" to="/insight/placement/2021">
                    All
                  </BranchLink>
                </BranchDiv>
      ...
      <CompanyFetch url="placement" query={query} type="placement" year="2021" branch = "all"/>
    </>
  );
}
